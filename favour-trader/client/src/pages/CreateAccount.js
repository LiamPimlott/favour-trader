    ...
    render() {
        return (
            <div className={'container'}>
                ...
                <div className={'row'}>
                        <Card outline className={'col-md-6 signup-center'}>
                            <CardTitle className={'p-2'}>Sign Up</CardTitle>
                            <Form className={'p-3'}>
                                <FormGroup row>
                                    <Label for="firstName" className={'text-left'} sm={4}>First Name: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="lastName" className={'text-left'} sm={4}>Last Name: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="streetNumber" className={'text-left'}  sm={4}>Street Number: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="street" className={'text-left'} sm={4}>Street: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="postalCode" className={'text-left'} sm={4}>Postal Code/ZIP: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="country" className={'text-left'} sm={4}>Country: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="city" className={'text-left'} sm={4}>City: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="state" className={'text-left'} sm={4}>State/Province: </Label>
                                    <Col sm={8}>
                                        <Input type="text"
                                ...
                                <FormGroup row>
                                    <Label for="email" className={'text-left'} sm={4}>Email: </Label>
                                    <Col sm={8}>
                                        <Input type="email"
                                ...
                                <FormGroup row>
                                    <Label for="confirmEmail" className={'text-left'} sm={4}>Confirm Email: </Label>
                                    <Col sm={8}>
                                        <Input type="email"
                                               name="confirmEmail"
                                               id="confirmEmail"
                                ...
                                <FormGroup row>
                                    <Label for="password" className={'text-left'} sm={4}>Password: </Label>
                                    <Col sm={8}>
                                        <Input type="password"
                                ...
                                <FormGroup row>
                                    <Label for="confirmPassword" className={'text-left'} sm={4}>Confirm Password: </Label>
                                    <Col sm={8}>
                                        <Input type="password"
