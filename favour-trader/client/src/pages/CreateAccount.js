        ...
        return (
            <Form>
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="firstName" id="firstName" placeholder=" ex. Joe "
                ...
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="password" id="lastName" placeholder=" ex. Blow "
                               onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="streetNumber" id="streetNumber"
                               placeholder=" ex. 100 " onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label style={formTextStyle} for="street" sm={2}>Street </Label>
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="street" id="street"
                               placeholder=" ex. Favour Street " onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label style={formTextStyle} for="postalCode" sm={2}>Postal Code/ZIP </Label>
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="postalCode" id="postalCode"
                               placeholder=" ex. A1A 1A1 " onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label style={formTextStyle} for="city" sm={2}>City </Label>
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="city" id="city" placeholder=" ex. Winnipeg "
                               onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="text" name="state" id="state" placeholder=" ex. Manitoba "
                               onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="email" name="email" id="email"
                               placeholder=" ex. favourtrader@gmail.com" onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label style={formTextStyle} for="confirmEmail" sm={2}>Confirm Email </Label>
                    <Col sm={15}>
                        <Input style={inputStyle} type="email" name="confirmEmail" id="confirmEmail"
                               onChange={this.onChange}/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                ...
                <FormGroup row>
                    ...
                    <Col sm={15}>
                        <Input style={inputStyle} type="password" name="confirmPassword" id="confirmPassword"
                               onChange={this.onChange}/>
                    </Col>
                </FormGroup>
